...
const portfolioData = [
    // Generado automáticamente - 2025-09-20T19:49:09.101871
    ...
    { name: "Electro - UnMixed", file: "Electro - UnMixed.mp3", genre: "electronic", size: 563247 },
    { name: "House - Mixed", file: "House - Mixed.mp3", genre: "mixed", size: 683243 },
    { name: "House - UnMixed", file: "House - UnMixed.mp3", genre: "mixed", size: 683245 },
    { name: "Reggaeton - Mixed", file: "Reggaeton - Mixed.mp3", genre: "reggaeton", size: 643407 },
    { name: "Reggaeton - UnMixed", file: "Reggaeton - UnMixed.mp3", genre: "reggaeton", size: 643409 },
    { name: "Reggaeton 2 - Mixed", file: "Reggaeton 2 - Mixed.mp3", genre: "reggaeton", size: 723089 },
    { name: "Reggaeton 2 - UnMixed", file: "Reggaeton 2 - UnMixed.mp3", genre: "reggaeton", size: 723091 },
    { name: "Trap - Mixed", file: "Trap - Mixed.mp3", genre: "hip-hop", size: 643402 },
    { name: "Trap - UnMixed", file: "Trap - UnMixed.mp3", genre: "hip-hop", size: 643404 }
];

// Ideas data - organized by month folders (Ideas)
const ideasData = [
    // Generado automáticamente - 2025-09-20T19:49:09.101529
...
const beats = [
    // Generado automáticamente - 2025-09-20T19:49:09.100367
    ...
    { name: "Demonio", file: "Dark Boom Bap/Demonio.mp3", genre: "dark-boom-bap", size: 3889157 },
    ...
    { name: "Santeria", file: "Dark Boom Bap/Santeria.mp3", genre: "dark-boom-bap", size: 4259238 },
    ...
    { name: "Atraco - Intro", file: "Dark Boom Bap/Atraco - Intro.mp3", genre: "dark-boom-bap", size: 3990924 },
    ...
    { name: "Feria - Intro", file: "Dark Boom Bap/Feria - Intro.mp3", genre: "dark-boom-bap", size: 4546283 },
    ...
    { name: "THC - Intro", file: "Dark Boom Bap/THC - Intro.mp3", genre: "dark-boom-bap", size: 3844041 },
    ...
    { name: "Vago", file: "Dark Boom Bap/Vago.mp3", genre: "dark-boom-bap", size: 4131554 },
    ...
    { name: "Lokote", file: "Dark Boom Bap/Lokote.mp3", genre: "dark-boom-bap", size: 3400996 },
    { name: "Erizo", file: "Dark Boom Bap/Erizo.mp3", genre: "dark-boom-bap", size: 3717795 },
    ...
    { name: "Bestia", file: "Dark Boom Bap/Bestia.mp3", genre: "dark-boom-bap", size: 3690436 },
    ...
    { name: "Paimon", file: "Dark Boom Bap/Paimon.mp3", genre: "dark-boom-bap", size: 4411876 },
    ...
    { name: "Loca Vida", file: "Dark Boom Bap/Loca Vida.mp3", genre: "dark-boom-bap", size: 3688999 },
    { name: "Insomnio", file: "Dark Boom Bap/Insomnio.mp3", genre: "dark-boom-bap", size: 3843078 },
    ...
    { name: "Intro - Negocio", file: "Dark Boom Bap/Intro - Negocio.mp3", genre: "dark-boom-bap", size: 4660045 },
    ...
    { name: "Pirata", file: "Dark Boom Bap/Pirata.mp3", genre: "dark-boom-bap", size: 3439396 },
    { name: "Punto", file: "Dark Boom Bap/Punto.mp3", genre: "dark-boom-bap", size: 3905955 },
    { name: "Calmado", file: "Boom Bap/Calmado.mp3", genre: "boom-bap", size: 4417157 },
...
const DARK_BOOM_BAP_FILES = new Set([
    "Ashes.mp3","Stolas.mp3","Gargola.mp3","Infinite Labyrinth.mp3","Quimico.mp3","Dracula.mp3","Ouroboros.mp3","True Grit.mp3","Dangerous.mp3","Demonio.mp3","Monster.mp3","Viaje.mp3","Problema.mp3","7 Kilos.mp3","Engulfed By Madness.mp3","Sol Negro.mp3","Santeria.mp3","Magia.mp3","Beast.mp3","Cerberus.mp3","Subconscious.mp3","Demente.mp3","Rage.mp3","Legacy.mp3","Atraco - Intro.mp3","Transdimensional Picnic.mp3","Belial.mp3","Ice Box.mp3","Tinta Negra.mp3","Roto.mp3","Expanded Perception.mp3","Maldito.mp3","Bizarre Dream.mp3","Feria - Intro.mp3","Ritual Night.mp3","Joker.mp3","Illusion of Choice.mp3","Blood Stain.mp3","Ethereal Illusions.mp3","Diamond Cut.mp3","Walking Through Chaos.mp3","Smoke.mp3","Most Wanted.mp3","Void.mp3","Smoke - Griselda.mp3","Mente Rota.mp3","THC - Intro.mp3","Noche.mp3","Clandestine.mp3","Night Light.mp3","From The Darkness.mp3","Medusa.mp3","Furious.mp3","Flota.mp3","Robbery.mp3","Abnormal Thoughts.mp3","Melting Mind.mp3","Ketamine.mp3","Basilisco.mp3","Mad.mp3","Infinite Dream.mp3","Money In Hand.mp3","Vago.mp3","Final Boss.mp3","Haze.mp3","Lokote.mp3","Erizo.mp3","Cursed.mp3","Millitia.mp3","Ya se la Saben.mp3","Bestia.mp3","Ain't Easy.mp3","Hallucinations.mp3","illuminati.mp3","Headshot.mp3","Paimon.mp3","Dark Knight.mp3","100k Stack.mp3","Pensamientos.mp3","Night Plan.mp3","Voices on My Head.mp3","Andromeda.mp3","Brujo.mp3","Orias.mp3","Moloc.mp3","Ira.mp3","Loca Vida.mp3","Insomnio.mp3","Uncut Lines.mp3","Ares.mp3","Phantom Shadow.mp3","Intro - Negocio.mp3","3 Gramos.mp3","UFO Ride.mp3","Not Easy.mp3","Machiavelli.mp3","Mysterious-Force.mp3","Witchcraft.mp3","Dark Boom Bap - Void.mp3","Pirata.mp3","Punto.mp3"
]);
...
let portfolioIsPlaying = false;
let portfolioAudioElement = null;
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize data based on current mode
...
function initializePortfolio() {
    portfolioAudioElement = new Audio();
    portfolioAudioElement.preload = 'metadata';
    
    // Portfolio audio events
    portfolioAudioElement.addEventListener('loadedmetadata', () => {
        const duration = document.getElementById('portfolioDuration');
        if (duration) duration.textContent = formatTime(portfolioAudioElement.duration);
    });
    
    portfolioAudioElement.addEventListener('timeupdate', () => {
        const currentTime = document.getElementById('portfolioCurrentTime');
        const progress = document.getElementById('portfolioProgress');
        
        if (currentTime) currentTime.textContent = formatTime(portfolioAudioElement.currentTime);
        if (progress && portfolioAudioElement.duration) {
            const percentage = (portfolioAudioElement.currentTime / portfolioAudioElement.duration) * 100;
            progress.style.width = percentage + '%';
        }
    });
    
    portfolioAudioElement.addEventListener('ended', () => {
        portfolioNextTrack();
    });
    
    portfolioAudioElement.addEventListener('play', () => {
        portfolioIsPlaying = true;
        updatePortfolioPlayButton();
        updatePortfolioTrackCards();
    });
    
    portfolioAudioElement.addEventListener('pause', () => {
        portfolioIsPlaying = false;
        updatePortfolioPlayButton();
        updatePortfolioTrackCards();
    });
...
function setupPortfolioEventListeners() {
    ...
    if (portfolioClose) {
        portfolioClose.addEventListener('click', () => {
            ...
            if (portfolioAudioElement && portfolioIsPlaying) {
                portfolioAudioElement.pause();
            }
        });
    }
    ...
    const portfolioVolumeSlider = document.getElementById('portfolioVolumeSlider');
    const portfolioProgressBar = document.querySelector('.portfolio-progress-bar');
    
    if (portfolioPlayBtn) {
        portfolioPlayBtn.addEventListener('click', portfolioTogglePlay);
    }
    
    if (portfolioPrevBtn) {
        portfolioPrevBtn.addEventListener('click', portfolioPreviousTrack);
    }
    
    if (portfolioNextBtn) {
        portfolioNextBtn.addEventListener('click', portfolioNextTrack);
    }
    
    if (portfolioVolumeSlider) {
        portfolioVolumeSlider.addEventListener('input', (e) => {
            if (portfolioAudioElement) {
                portfolioAudioElement.volume = e.target.value / 100;
            }
        });
    }
    
    if (portfolioProgressBar) {
        portfolioProgressBar.addEventListener('click', (e) => {
            if (portfolioAudioElement && portfolioAudioElement.duration) {
                const rect = portfolioProgressBar.getBoundingClientRect();
                const clickX = e.clientX - rect.left;
                const percentage = clickX / rect.width;
                portfolioAudioElement.currentTime = percentage * portfolioAudioElement.duration;
            }
        });
    }
...
function renderPortfolioTracks() {
    const container = document.getElementById('portfolioTracksContainer');
    if (!container) return;
    ...
    if (portfolioData.length === 0) {
        container.innerHTML = `
            <div class="portfolio-empty">
                ...
                <p>Portfolio tracks will appear here once you add audio files to the "Portafolio" folder.</p>
            </div>
        `;
        return;
    }
    
    container.innerHTML = portfolioData.map((track, index) => `
        <div class="portfolio-track-row" data-index="${index}">
            <div class="portfolio-track-title">${track.name}</div>
            <button class="portfolio-track-play-btn" onclick="playPortfolioTrack(${index})">
                <i class="fas fa-play"></i>
            </button>
        </div>
    `).join('');
...
function playPortfolioTrack(index) {
    if (!portfolioData[index]) return;
    
    const track = portfolioData[index];
    const audioPath = `Portafolio/${encodePath(track.file)}?v=${BUILD_TOKEN}`;
    
    // If clicking on the currently playing track, toggle play/pause
    if (portfolioCurrentIndex === index) {
        if (portfolioIsPlaying) {
            portfolioAudioElement.pause();
        } else {
            portfolioAudioElement.play().catch(console.error);
        }
        return;
    }
    ...
    portfolioAudioElement.src = audioPath;
    portfolioAudioElement.play().catch(console.error);
    
    // Update current track display
    const currentTrack = document.getElementById('portfolioCurrentTrack');
    if (currentTrack) {
...
function portfolioTogglePlay() {
    if (!portfolioAudioElement) return;
    
    if (portfolioData.length === 0) return;
    
    if (!portfolioAudioElement.src || portfolioAudioElement.src === '') {
        playPortfolioTrack(0);
        return;
    }
...
function portfolioPreviousTrack() {
    if (portfolioData.length === 0) return;
    
    portfolioCurrentIndex = portfolioCurrentIndex > 0 ? portfolioCurrentIndex - 1 : portfolioData.length - 1;
    playPortfolioTrack(portfolioCurrentIndex);
}

function portfolioNextTrack() {
    if (portfolioData.length === 0) return;
    
    portfolioCurrentIndex = (portfolioCurrentIndex + 1) % portfolioData.length;
    playPortfolioTrack(portfolioCurrentIndex);
}

function updatePortfolioPlayButton() {
    const playBtn = document.getElementById('portfolioPlayBtn');
    if (playBtn) {
        const icon = playBtn.querySelector('i');
        if (icon) {
            icon.className = portfolioIsPlaying ? 'fas fa-pause' : 'fas fa-play';
        }
    }
}

function updatePortfolioTrackCards() {
    const rows = document.querySelectorAll('.portfolio-track-row');
    rows.forEach((row, index) => {
        row.classList.toggle('playing', index === portfolioCurrentIndex && portfolioIsPlaying);
        
        const playBtn = row.querySelector('.portfolio-track-play-btn i');
        if (playBtn) {
            if (index === portfolioCurrentIndex && portfolioIsPlaying) {
                playBtn.className = 'fas fa-pause';
            } else {
                playBtn.className = 'fas fa-play';
            }
