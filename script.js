...
const portfolioData = [
    // Generado automáticamente - 2025-09-05T02:18:03.283360
...
const ideasData = [
    // Generado automáticamente - 2025-09-05T02:18:03.283255
...
const beats = [
    // Generado automáticamente - 2025-09-05T02:18:03.282824
...
function renderPortfolioTracks() {
    ...
    container.innerHTML = portfolioData.map((track, index) => `
        <div class="portfolio-track-row" data-index="${index}">
            ...
            <div class="portfolio-track-genre">${track.genre}</div>
            <div class="portfolio-track-duration">--:--</div>
...
function playPortfolioTrack(index) {
    ...
    if (portfolioAudioElement.src.includes(track.file) && portfolioIsPlaying) {
        portfolioAudioElement.pause();
        return;
    }
